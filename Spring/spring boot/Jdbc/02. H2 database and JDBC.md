...
```
Spring Boot can **automatically configure the DataSource** for you if you simply set the relevant properties in your `application.properties` or `application.yml`
